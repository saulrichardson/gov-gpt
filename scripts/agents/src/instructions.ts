...
export function buildEndpointAgentInstructions({
  ...
  return [
    ...
    "- Prefer a complete validated first pass over exhaustive exploration. Stop once the major documented fields, live availability, response grain, business semantics, and material caveats are classified.",
