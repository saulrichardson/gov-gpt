...
export function fullAccessInstructionBlock(role: string): string[] {
  return [
    "",
    "Full-access autonomous mode:",
    `- This ${role} is running with full local shell access through full_access_shell_command.`,
    ...
    "- For full_access_shell_command, pass explicit null for cwd, timeoutMs, or maxOutputChars when you want defaults.",
    ...
    "- Keep the final deliverable coherent and validated. Full-access mode increases investigative and execution freedom; it does not lower evidence, artifact, or schema standards.",
