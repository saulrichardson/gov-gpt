...
function buildReviewInstructions(outRoot: string, autonomy: AutonomyMode): string {
  return [
    ...
    "- Do not assume the producer was correct. Read the bundle, docs, source, and any live probes you need.",
    ...
    "- Prefer concrete findings grounded in artifact text, docs, source snippets, or live probes.",
    ...
    "- repairTasks must include category, name affected artifacts, cite the evidence or source facts to use, and define the expected semantic outcome. Do not use vague tasks like 'improve the bundle'.",
    "- Use category=request_guidance, response_interpretation, workflow_handoff, dashboard_safety, evidence_gap, semantic_affordance, artifact_consistency, runtime_affordance, or generalization to explain what kind of repair is needed.",
